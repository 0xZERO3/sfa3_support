...
program = {
	{
		...
		obj = {
			...
			element = {
				...
				speed_y			= {sign = "u",      size = 2,       offset = 0x0044},
				speed_y_sub		= {sign = "u",      size = 2,       offset = 0x0046},
				accel_x			= {sign = "s",      size = 2,       offset = 0x0048},
				accel_x_sub		= {sign = "u",      size = 2,       offset = 0x004A},
				accel_y			= {sign = "u",      size = 2,       offset = 0x004C},
				accel_y_sub		= {sign = "u",      size = 2,       offset = 0x004E},
	...
	},
	{
		...
		obj = {
			...
			element = {
				...
				motion03		= {sign = "u",      size = 1,       offset = 0x0007},
				direction		= {sign = "u",      size = 1,       offset = 0x000B},
				x_sub			= {sign = "u",      size = 2,       offset = 0x0010},
				x				= {sign = "s",      size = 2,       offset = 0x0012},
				y_sub			= {sign = "u",      size = 2,       offset = 0x0014},
				y				= {sign = "u",      size = 2,       offset = 0x0016},
				anim_ptr		= {sign = "u",      size = 4,       offset = 0x001C},
				head_addr		= {sign = "u",      size = 4,       offset = 0x0090},
				body_addr		= {sign = "u",      size = 4,       offset = 0x0094},
				foot_addr		= {sign = "u",      size = 4,       offset = 0x0098},
	...
	},
	{
		...
		obj = {
			...
			element = {
				...
				direction		= {sign = "u",      size = 1,       offset = 0x000B},
				x				= {sign = "s",      size = 2,       offset = 0x0012},
				x_sub			= {sign = "u",      size = 2,       offset = 0x0014},
				y				= {sign = "u",      size = 2,       offset = 0x0016},
				y_sub			= {sign = "u",      size = 2,       offset = 0x0018},
	...
	},
	{
		...
		obj = {
			...
			element = {
				...
				x_sub			= {sign = "u",      size = 2,       offset = 0x003C},
				y				= {sign = "u",      size = 2,       offset = 0x0042},
				y_sub			= {sign = "u",      size = 2,       offset = 0x0040},
