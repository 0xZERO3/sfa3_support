...
program = {
	...
	},
	{
		...
		menu_enabled = false,
		delay_adjust = function() return (0x02) end,
		scr_shift_x = function() if (G_emulator == "mame") then return (-0x0D) elseif (G_emulator == "bizhawk") then return (0x06) elseif (G_emulator == "psxjin") then return (0x00) end end,
		scr_shift_y = function() if (G_emulator == "mame") then return (0x08)  elseif (G_emulator == "bizhawk") then return (0x07) elseif (G_emulator == "psxjin") then return (0x07) end end,
		scale_x = 1,
		scale_y = 1,
...
--			{desc = "unlock03", addr = 0x001143F8, data = 0x01, size = 1, how = 0, enable = true},
	...
	},
	{
		...
		scr_shift_y = function() if (G_emulator == "mame") or (G_emulator == "bizhawk") then return (0x37) elseif (G_emulator == "vbarr") then return (0x0C) end end,
		scale_x = 1/2,
		scale_y = 2/3,
		proj_alive = 0x02000000,
		addr_shift = (0x00000000),
